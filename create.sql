...
CREATE TABLE colection (id_collection serial primary key, collection_name varchar(100) not null, year integer);
...
CREATE TABLE colection_tracks (
 id_collection integer references colection(id_collection),
